      ...
      <div className="container mx-auto px-4 py-20 relative">
        <div className="max-w-5xl mx-auto text-center">
          <div className="space-y-6 mb-16">
            <h1 className="text-8xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-500">
              Whal-E
            </h1>
          ...
          <button
            onClick={login}
            className="group mb-10 px-8 py-4 bg-primary hover:bg-primary/90 rounded-full text-lg font-medium text-primary-foreground transition-all flex items-center gap-2 mx-auto"
          >
            Get Started
...
function FeatureCard({ icon: Icon, title, description }: Feature) {
  return (
    <div className="p-8 rounded-2xl bg-card/50 backdrop-blur-sm border border-border hover:border-primary/50 transition-colors flex flex-col items-center">
